...
number_Per_Person = int(input("\nEnter the number of hot dogs each person will be given: "))
...
# After Setting Package Amounts, To Find The Leftovers. Use How Many Packages And Multiply
# With How Many Are In A Package. Then Subtract How Many Needed To Get How Many Leftovers
# There Would Be.

hot_Dogs_Leftover = (hot_Dog_Packages * hot_Dogs) - total_Hot_Dogs_Needed
hot_Dog_Buns_Leftover = (hot_Dog_Bun_Packages * hot_Dog_Buns) - total_Hot_Dog_Buns_Needed
